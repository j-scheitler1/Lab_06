...
public class ATM {
	...
	public ATM(Scanner scanner, String username, String password) {
	...
	public void start() {
		...
		while (running) {
			...
			switch (choice) {
				case 1 -> AccountMenu.handleCheckings(scanner, user.getCheckings(), user.getSavings(), user.getUtility());
				case 2 -> AccountMenu.handleSavings(scanner, user.getSavings(), user.getCheckings());
				case 3 -> AccountMenu.handleUtility(scanner, user.getUtility());
				case 0 -> resetDailyLimits();
				case 9 -> {
	...
	private void printMainMenu() {
		...
		System.out.println("0: Advance to next day");
		System.out.println("9: Exit ATM");
		System.out.print("Choice: ");
	}

	private void resetDailyLimits() {
		user.getCheckings().resetDailyLimits(5000.0, 500.0);
		user.getSavings().resetDailyLimits(5000.0, 100.0);
		System.out.println("Limits reset for the next day.");
	}
}
